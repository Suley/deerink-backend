...
public interface OrderItemMapper {
    @Insert("INSERT INTO order_item (id, picture, prompt, model, seed, params, custom_type, custom_param, order_id, print_status, picture_base64) " +
            "VALUES (#{orderItem.id}, #{orderItem.picture}, #{orderItem.prompt}, #{orderItem.model}, #{orderItem.seed}, #{orderItem.params}, " +
            "#{orderItem.customType}, #{orderItem.customParam}, #{orderItem.orderId}, #{orderItem.printStatus}, #{orderItem.pictureBase64})")
